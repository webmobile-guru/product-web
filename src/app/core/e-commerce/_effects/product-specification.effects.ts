...
// Services
import { ProductSpecificationsService, FireProductSpecificationsService } from '../_services/';
// State
...
export class ProductSpecificationEffects {
    ...
    loadProductSpecificationsPage$ = this.actions$
        .pipe(
            ...
            mergeMap(( { payload } ) => this.fireProuctSepcificationService.findProductSpecs(payload.page, payload.productId)),
    ...
    deleteProductSpecification$ = this.actions$
        .pipe(
            ...
            mergeMap(( { payload } ) => {
                    ...
                    return this.fireProuctSepcificationService.deleteProductSpec(payload.id);
                }
            ),
            map(() => {
    ...
    deleteProductSpecifications$ = this.actions$
        .pipe(
            ...
            mergeMap(( { payload } ) => {
                    this.store.dispatch(new ProductSpecificationsPageToggleLoading({ isLoading: true }));
                    return this.fireProuctSepcificationService.deleteProductSpecifications(payload.ids);
                }
            ),
            map(() => {
                return this.hideLoadingDistpatcher;
    ...
    updateProductSpecification$ = this.actions$
        .pipe(
            ...
            mergeMap(( { payload } ) => {
                this.store.dispatch(new ProductSpecificationsPageToggleLoading({ isLoading: true }));
                return this.fireProuctSepcificationService.updateProductSpec(payload.productSpecification);
            }),
            map(() => {
                return this.hideLoadingDistpatcher;
            }),
    ...
    createProductSpecification$ = this.actions$
        .pipe(
            ...
            mergeMap(( { payload } ) => {
                this.store.dispatch(new ProductSpecificationsPageToggleLoading({ isLoading: true }));
                return this.fireProuctSepcificationService.createProductSpec(payload.productSpecification).pipe(
                    tap(res => {
    ...
    constructor(
        ...
        private fireProuctSepcificationService: FireProductSpecificationsService) { }
}
