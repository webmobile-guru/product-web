...
import { FireProductsService } from '../_services/fire-products.service';
...
export class ProductEffects {
    ...
    loadProductsPage$ = this.actions$
        .pipe(
            ...
            mergeMap(({ payload }) => {
                ...
                const requestToServer = this.fireProductsService.findProducts(payload.page);
    ...
    deleteProduct$ = this.actions$
        .pipe(
            ...
            mergeMap(({ payload }) => {
                ...
                return this.fireProductsService.deleteProduct(payload.id);
    ...
    deleteProducts$ = this.actions$
        .pipe(
            ...
            mergeMap(({ payload }) => {
                this.store.dispatch(this.showLoadingDistpatcher);
                return this.fireProductsService.deleteProducts(payload.ids);
    ...
    updateProductsStatus$ = this.actions$
        .pipe(
            ...
            mergeMap(({ payload }) => {
                this.store.dispatch(this.showLoadingDistpatcher);
                return this.fireProductsService.updateStatusForProduct(payload.products, payload.status);
    ...
    updateProduct$ = this.actions$
        .pipe(
            ...
            mergeMap(({ payload }) => {
                this.store.dispatch(this.showLoadingDistpatcher);
                return this.fireProductsService.updateProduct(payload.product);
    ...
    createProduct$ = this.actions$
        .pipe(
            ...
            mergeMap(({ payload }) => {
                this.store.dispatch(this.showLoadingDistpatcher);
                return this.fireProductsService.createProduct(payload.product).pipe(
    ...
    constructor(
        ...
        private fireProductsService: FireProductsService
    ) { }
}
