...
import { Observable, defer, of, forkJoin, combineLatest } from 'rxjs';
// NGRX
...
export class UserEffects {
    ...
    loadUsersPage$ = this.actions$
        .pipe(
            ...
            mergeMap(( { payload } ) => {
                ...
                const requestToServer = this.fireAuthService.findUsers(payload.page);
    ...
    updateUser$ = this.actions$
        .pipe(
            ...
            mergeMap(( { payload } ) => {
                this.store.dispatch(this.showActionLoadingDistpatcher);
                return this.fireAuthService.updateUser(payload.user);
    ...
    createUser$ = this.actions$
        .pipe(
            ...
            mergeMap(( { payload } ) => {
                this.store.dispatch(this.showActionLoadingDistpatcher);
                return this.fireAuthService.createUser(payload.user).pipe(
                    tap(res => {
