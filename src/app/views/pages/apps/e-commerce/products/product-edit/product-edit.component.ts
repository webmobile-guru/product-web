...
import { FireProductsService } from '../../../../../../core/e-commerce/_services/fire-products.service';
...
export class ProductEditComponent implements OnInit, OnDestroy {
	...
	constructor(
		...
		private fireProductService: FireProductsService,
	...
	loadProductFromService(productId) {
		this.fireProductService.getProductById(productId).subscribe(res => {
