...
export class RegisterComponent implements OnInit, OnDestroy {
    ...
    */
	...
	submit() {
		...
		this.fireAuthService.signUp(controls.email.value, controls.password.value)
		.then((res) => {
			this.loading = false;
			console.log('successfully fire signUp', res.user);
			...
			// this.fireAuthService.createUser(_user)
			// 	.then((res) => {
			// 		console.log('new user data is stored in Firebase Database: ', res)
			// 	})
			this.fireAuthService.setUserData(userData);
