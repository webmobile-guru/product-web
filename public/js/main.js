                ...
                submitHandler: function( form ) {
                    ...
                    $.ajax({
                        ...
                        success: function( msg ) {
                            var result, cls;                            
                            if ( msg == 'Success' ) {                                
                                result = 'Message Sent Successfully To Email Administrator. ( You can change the email management a very easy way to get the message of customers in the layout manual )';
                                cls = 'msg-success';
                            } else {
